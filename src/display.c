...
void display_update(uint8_t q1, uint8_t q2, uint8_t q3, uint8_t q4) {
	...
	buffer[k++] = (row7 & col04) * GREEN;
	buffer[k++] = (row7 & col03) * BLUE;
	buffer[k++] = (row7 & col03) * RED;
	buffer[k++] = (row7 & col02) * GREEN;
	buffer[k++] = (row7 & col02) * BLUE;
	...
	// row 7
	// k = 64
	buffer[k++] = (row6 & col11) * RED;
	buffer[k++] = (row6 & col11) * RED;
	buffer[k++] = (row6 & col08) * RED;
	buffer[k++] = (row6 & col08) * RED;
	buffer[k++] = (row6 & col06) * RED;
	buffer[k++] = (row6 & col06) * RED;
	buffer[k++] = (row7 & col06) * RED;
	buffer[k++] = (row7 & col06) * RED;
	...
	// row 7 (sharp, bottom)
	buffer[k++] = (row6 & col14) * RED;
	buffer[k++] = (row6 & col14) * RED;
	buffer[k++] = (row6 & col15) * RED;
	buffer[k++] = (row6 & col15) * RED;
	buffer[k++] = (row6 & col15) * RED;
	buffer[k++] = (row6 & col15) * RED;
	buffer[k++] = (row6 & col14) * RED;
	...
	// row 6 (sharp, top)
	buffer[k++] = (row6 & col12) * RED;
	buffer[k++] = (row6 & col12) * RED;
	buffer[k++] = (row6 & col13) * RED;
	buffer[k++] = (row6 & col13) * RED;
	buffer[k++] = (row6 & col13) * RED;
	buffer[k++] = (row6 & col13) * RED;
	buffer[k++] = (row6 & col12) * RED;
	...
	// row 5
	buffer[k++] = (row5 & col17) * RED;
	buffer[k++] = (row5 & col17) * RED;
	buffer[k++] = (row5 & col16) * RED;
	buffer[k++] = (row5 & col16) * RED;
	buffer[k++] = (row5 & col15) * RED;
	buffer[k++] = (row5 & col15) * RED;
	buffer[k++] = (row5 & col14) * RED;
	buffer[k++] = (row5 & col14) * RED;
	buffer[k++] = (row5 & col13) * RED;
	buffer[k++] = (row5 & col13) * RED;
	buffer[k++] = (row5 & col12) * RED;
	buffer[k++] = (row5 & col12) * RED;
	buffer[k++] = (row5 & col11) * RED;
	buffer[k++] = (row5 & col11) * RED;
	buffer[k++] = (row5 & col10) * RED;
	buffer[k++] = (row5 & col10) * RED;
	buffer[k++] = (row5 & col09) * RED;
	buffer[k++] = (row5 & col09) * RED;
	buffer[k++] = (row5 & col08) * RED;
	buffer[k++] = (row5 & col08) * RED;
	buffer[k++] = (row5 & col07) * RED;
	buffer[k++] = (row5 & col07) * RED;
	buffer[k++] = (row5 & col06) * RED;
	buffer[k++] = (row5 & col06) * RED;
	buffer[k++] = (row5 & col05) * RED;
	buffer[k++] = (row5 & col05) * RED;
	buffer[k++] = (row5 & col04) * RED;
	buffer[k++] = (row5 & col04) * RED;
	buffer[k++] = (row5 & col03) * RED;
	buffer[k++] = (row5 & col03) * RED;
	buffer[k++] = (row5 & col02) * RED;
	buffer[k++] = (row5 & col02) * RED;
	buffer[k++] = (row5 & col01) * RED;
	buffer[k++] = (row5 & col01) * RED;
	...
	buffer[k++] = (row5 & col17) * RED;
		...
		// row 4
	buffer[k++] = (row4 & col17) * RED;
	buffer[k++] = (row4 & col17) * RED;
	buffer[k++] = (row4 & col16) * RED;
	buffer[k++] = (row4 & col16) * RED;
	buffer[k++] = (row4 & col15) * RED;
	buffer[k++] = (row4 & col15) * RED;
	buffer[k++] = (row4 & col14) * RED;
	buffer[k++] = (row4 & col14) * RED;
	buffer[k++] = (row4 & col13) * RED;
	buffer[k++] = (row4 & col13) * RED;
	buffer[k++] = (row4 & col12) * RED;
	buffer[k++] = (row4 & col12) * RED;
	buffer[k++] = (row4 & col11) * RED;
	buffer[k++] = (row4 & col11) * RED;
	buffer[k++] = (row4 & col10) * RED;
	buffer[k++] = (row4 & col10) * RED;
	buffer[k++] = (row4 & col09) * RED;
	buffer[k++] = (row4 & col09) * RED;
	buffer[k++] = (row4 & col08) * RED;
	buffer[k++] = (row4 & col08) * RED;
	buffer[k++] = (row4 & col07) * RED;
	buffer[k++] = (row4 & col07) * RED;
	buffer[k++] = (row4 & col06) * RED;
	buffer[k++] = (row4 & col06) * RED;
	buffer[k++] = (row4 & col05) * RED;
	buffer[k++] = (row4 & col05) * RED;
	buffer[k++] = (row4 & col04) * RED;
	buffer[k++] = (row4 & col04) * RED;
	buffer[k++] = (row4 & col03) * RED;
	buffer[k++] = (row4 & col03) * RED;
	buffer[k++] = (row4 & col02) * RED;
	buffer[k++] = (row4 & col02) * RED;
	buffer[k++] = (row4 & col01) * RED;
	buffer[k++] = (row4 & col01) * RED;
	...
	// row 3
	buffer[k++] = (row3 & col17) * GREEN;
	buffer[k++] = (row3 & col17) * GREEN;
	buffer[k++] = (row3 & col16) * GREEN;
	buffer[k++] = (row3 & col16) * GREEN;
	buffer[k++] = (row3 & col15) * GREEN;
	buffer[k++] = (row3 & col15) * GREEN;
	buffer[k++] = (row3 & col14) * GREEN;
	buffer[k++] = (row3 & col14) * GREEN;
	buffer[k++] = (row3 & col13) * GREEN;
	buffer[k++] = (row3 & col13) * GREEN;
	buffer[k++] = (row3 & col12) * GREEN;
	buffer[k++] = (row3 & col12) * GREEN;
	buffer[k++] = (row3 & col11) * GREEN;
	buffer[k++] = (row3 & col11) * GREEN;
	buffer[k++] = (row3 & col10) * GREEN;
	buffer[k++] = (row3 & col10) * GREEN;
	buffer[k++] = (row3 & col09) * GREEN;
	buffer[k++] = (row3 & col09) * GREEN;
	buffer[k++] = (row3 & col08) * GREEN;
	buffer[k++] = (row3 & col08) * GREEN;
	buffer[k++] = (row3 & col07) * GREEN;
	buffer[k++] = (row3 & col07) * GREEN;
	buffer[k++] = (row3 & col06) * GREEN;
	buffer[k++] = (row3 & col06) * GREEN;
	buffer[k++] = (row3 & col05) * GREEN;
	buffer[k++] = (row3 & col05) * GREEN;
	buffer[k++] = (row3 & col04) * GREEN;
	buffer[k++] = (row3 & col04) * GREEN;
	buffer[k++] = (row3 & col03) * GREEN;
	buffer[k++] = (row3 & col03) * GREEN;
	buffer[k++] = (row3 & col02) * GREEN;
	buffer[k++] = (row3 & col02) * GREEN;
	buffer[k++] = (row3 & col01) * GREEN;
	buffer[k++] = (row3 & col01) * GREEN;
	...
	// row 2
	buffer[k++] = (row2 & col17) * RED;
	buffer[k++] = (row2 & col17) * RED;
	buffer[k++] = (row2 & col16) * RED;
	buffer[k++] = (row2 & col16) * RED;
	buffer[k++] = (row2 & col15) * RED;
	buffer[k++] = (row2 & col15) * RED;
	buffer[k++] = (row2 & col14) * RED;
	buffer[k++] = (row2 & col14) * RED;
	buffer[k++] = (row2 & col13) * RED;
	buffer[k++] = (row2 & col13) * RED;
	buffer[k++] = (row2 & col12) * RED;
	buffer[k++] = (row2 & col12) * RED;
	buffer[k++] = (row2 & col11) * RED;
	buffer[k++] = (row2 & col11) * RED;
	buffer[k++] = (row2 & col10) * RED;
	buffer[k++] = (row2 & col10) * RED;
	buffer[k++] = (row2 & col09) * RED;
	buffer[k++] = (row2 & col09) * RED;
	buffer[k++] = (row2 & col08) * RED;
	buffer[k++] = (row2 & col08) * RED;
	buffer[k++] = (row2 & col07) * RED;
	buffer[k++] = (row2 & col07) * RED;
	buffer[k++] = (row2 & col06) * RED;
	buffer[k++] = (row2 & col06) * RED;
	buffer[k++] = (row2 & col05) * RED;
	buffer[k++] = (row2 & col05) * RED;
	buffer[k++] = (row2 & col04) * RED;
	buffer[k++] = (row2 & col04) * RED;
	buffer[k++] = (row2 & col03) * RED;
	buffer[k++] = (row2 & col03) * RED;
	buffer[k++] = (row2 & col02) * RED;
	buffer[k++] = (row2 & col02) * RED;
	buffer[k++] = (row2 & col01) * RED;
	buffer[k++] = (row2 & col01) * RED;
	...
	// row 1
	buffer[k++] = (row1 & col17) * RED;
	buffer[k++] = (row1 & col17) * RED;
	buffer[k++] = (row1 & col16) * RED;
	buffer[k++] = (row1 & col16) * RED;
	buffer[k++] = (row1 & col15) * RED;
	buffer[k++] = (row1 & col15) * RED;
	buffer[k++] = (row1 & col14) * RED;
	buffer[k++] = (row1 & col14) * RED;
	buffer[k++] = (row1 & col13) * RED;
	buffer[k++] = (row1 & col13) * RED;
	buffer[k++] = (row1 & col12) * RED;
	buffer[k++] = (row1 & col12) * RED;
	buffer[k++] = (row1 & col11) * RED;
	buffer[k++] = (row1 & col11) * RED;
	buffer[k++] = (row1 & col10) * RED;
	buffer[k++] = (row1 & col10) * RED;
	buffer[k++] = (row1 & col09) * RED;
	buffer[k++] = (row1 & col09) * RED;
	buffer[k++] = (row1 & col08) * RED;
	buffer[k++] = (row1 & col08) * RED;
	buffer[k++] = (row1 & col07) * RED;
	buffer[k++] = (row1 & col07) * RED;
	buffer[k++] = (row1 & col06) * RED;
	buffer[k++] = (row1 & col06) * RED;
	buffer[k++] = (row1 & col05) * RED;
	buffer[k++] = (row1 & col05) * RED;
	buffer[k++] = (row1 & col04) * RED;
	buffer[k++] = (row1 & col04) * RED;
	buffer[k++] = (row1 & col03) * RED;
	buffer[k++] = (row1 & col03) * RED;
	buffer[k++] = (row1 & col02) * RED;
	buffer[k++] = (row1 & col02) * RED;
	buffer[k++] = (row1 & col01) * RED;
	buffer[k++] = (row1 & col01) * RED;
